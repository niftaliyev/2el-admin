...
export const metadata: Metadata = {
  title: "Next.js Buttons | Elan.az Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Elan.az Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
