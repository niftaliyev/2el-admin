...
export const metadata: Metadata = {
  title: "Next.js Modals | Elan.az Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Elan.az Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
