...
export const metadata: Metadata = {
  title: "Next.js Badge | Elan.az Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Elan.az Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
