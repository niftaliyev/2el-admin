...
export const metadata: Metadata = {
  title: "Next.js Avatars | Elan.az Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Elan.az Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
